...
const Banner = () => {
    return (
        <section className="bg-4F5DE4 relative after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-[url('././assets/vector.png')] after:bg-no-repeat after:bg-center pb-[132px] z-50">
            <Header />
            <div className="md:mt-[50px] md:pt-[35px] container flex flex-wrap justify-between z-40 relative after:absolute after:top-0 after:left-0 after:w-full after:h-[701px] after:bg-[url('././assets/vectorL.png')] after:bg-no-repeat after:bg-center after:bg-cover after:-z-0">
